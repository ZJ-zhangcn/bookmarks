...
test('wallpaper tone CSS drives adaptive semi-transparent surfaces', () => {
  assert.match(css, /\[data-wallpaper-tone="light"\]\s*{[\s\S]*--adaptive-surface:\s*hsla\(222,\s*34%,\s*12%,\s*0\.28\)[\s\S]*--adaptive-surface-strong:\s*hsla\(222,\s*34%,\s*12%,\s*0\.42\)[\s\S]*--adaptive-border:\s*hsla\(210,\s*18%,\s*96%,\s*0\.18\)/);
  assert.match(css, /\[data-wallpaper-tone="dark"\]\s*{[\s\S]*--adaptive-surface:\s*hsla\(220,\s*13%,\s*10%,\s*0\.32\)[\s\S]*--adaptive-surface-strong:\s*hsla\(220,\s*13%,\s*10%,\s*0\.46\)[\s\S]*--adaptive-border:\s*hsla\(210,\s*18%,\s*96%,\s*0\.16\)/);
  assert.match(css, /\[data-theme="light"\]\[data-wallpaper-tone\]\s*{[\s\S]*--adaptive-surface:\s*hsla\(0,\s*0%,\s*100%,\s*0\.52\)[\s\S]*--adaptive-surface-strong:\s*hsla\(0,\s*0%,\s*100%,\s*0\.66\)[\s\S]*--adaptive-text:\s*hsl\(222,\s*34%,\s*12%\)/);
