...
export function cacheDOMElements() {
    DOM = {
        ...
        serviceStatusContainer: document.getElementById('serviceStatusContainer'),
        serviceStatusGrid: document.getElementById('serviceStatusGrid'),
        serviceStatusRefresh: document.getElementById('serviceStatusRefresh'),
        serviceStatusUpdatedAt: document.getElementById('serviceStatusUpdatedAt'),
        serviceStatusName: document.getElementById('serviceStatusName'),
        serviceStatusUrl: document.getElementById('serviceStatusUrl'),
        serviceStatusEnabled: document.getElementById('serviceStatusEnabled'),
        serviceStatusSaveBtn: document.getElementById('serviceStatusSaveBtn'),
        serviceStatusList: document.getElementById('serviceStatusList'),
        serviceStatusFormHint: document.getElementById('serviceStatusFormHint'),
