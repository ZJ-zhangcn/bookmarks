...
export let serviceStatuses = [];
export let serviceStatusInterval = null;
export let editingServiceStatusId = null;
...
export function setServiceStatuses(val) { serviceStatuses = Array.isArray(val) ? val : []; }
export function setServiceStatusInterval(val) { serviceStatusInterval = val; }
export function setEditingServiceStatusId(val) { editingServiceStatusId = val; }
